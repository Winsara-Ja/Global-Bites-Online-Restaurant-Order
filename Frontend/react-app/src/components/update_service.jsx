    ...
    const fetchUserData = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/catering/user/${id}`
        );
    ...
    <>
      ...
      <div className="service-update">
        ...
        <input
          ...
          onChange={handleInputChange}
          value={updatediscount?.dilivery_options}
        />
        <br></br>
        ...
        <input
          ...
          name="headcount"
          onChange={handleInputChange}
          value={updatediscount?.headcount}
        />
        <br></br>
        <button onClick={handleUpdate}>Update Serice</button>
        <br></br> <br></br>
      </div>
    </>
  );

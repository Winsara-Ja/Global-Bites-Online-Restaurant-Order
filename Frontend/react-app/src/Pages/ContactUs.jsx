...
export const ContactUs = () => {
  ...
  return (
    <>
      ...
      <Faq />
      <div className="back">
        <form ref={form} onSubmit={sendEmail} className="Conbox">
          <div class="ContactUs">
          ...
          <div className="Contact">
            ...
            <div className="flex">
              <span className="icon">
                ...
                >
                  <path
                    d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 
          ...
          <div className="Contact">
            ...
            <div className="flex">
              <span className="icon">
                ...
                >
                  <path
                    d="m10.036 8.278 9.258-7.79A1.979 1.979 0 0 
          ...
          <div className="feedbacksubmit">
            <input type="submit" value="Send" className="Conbutton" />
          </div>
        </form>
      </div>

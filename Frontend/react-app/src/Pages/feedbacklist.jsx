...
function UsersFeedback() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:5000/createfeedback", {
        name,
        userId,
        email,
        feedback,
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios
          .delete(`http://localhost:5000/deleteFeedback/${id}`)
          .then((res) => {
            Swal.fire({
              title: "Deleted!",
        ...
        <div className="FBpage">
            ...
            <div className="mt-8">
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <label htmlFor="name" className="FBName">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-4">
                  <label htmlFor="email" className="FBEmail">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="mb-4">
                  <label htmlFor="item" className="FBtext">
                    Item
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-4">
                  <label htmlFor="feedback" className="FBtext">
                    Feedback
                  </label>
                  <input
                    type="text"
          ...
          <div className="flex flex-col space-y-4">
            {filteredFeedbacks.map((feedback, index) => (
              <div className="feedback">
                ...
                <p className="text-white">Item: {feedback.item}</p>

...
import {
  ...
  resetResetStatus,
} from "../redux/user/userSlice"; // Import the new action creators
...
const ResetPassword = () => {
  ...
  return (
    <>
      <div className='bg-cover bg-[url("/9.jpg")] bg-opacity-10 p-20 h-screen'>
        <div className="p-5 max-w-lg mx-auto mb-20 bg-white  rounded-2xl">
          ...
          <div>
            <form className=" flex flex-col gap-4 " onSubmit={handleSubmit}>
              ...
              <button
                className="bg-[#f0b20a] bg-600 p-3 w-full rounded-lg text-white uppercase hover:opacity-85 disabled:opacity-10 "
                type="submit"
              >
                Reset Password
              </button>
